    ...
    <div class="container">
        <div class="row movie-details card-panel blue-grey darken-3">
            <div class="col s12 m4">
                <img src="{{'https://image.tmdb.org/t/p/w500/'.$show['poster_path']}}" alt="" class="responsive-img">
            </div>
            <div class="col s12 m7" style="margin-left: 30px;">
                <div>
                    <h4 class="white-text" style="line-height: 20px">{{$show['name']}}</h4>
                ...
                @if ($show['videos']['results']>0)
                <a href="https:/youtube.com/watch?v={{$show['videos']['results'][0]['key']}}" class="btn btn-large waves-effect waves-red orange darken-2" style="margin-top:20px;">
